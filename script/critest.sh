...
# create a user namespace, as the final stage of the mount is not as the root user.
...
# the directories, we need to make sure that the directories above the $BDIR are also traversable.
traverse_path "$BDIR"
