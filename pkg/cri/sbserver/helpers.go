...
func (c *criService) praseUsernsIDs(runtimeIDMap []*runtime.IDMapping) ([]runtimespec.LinuxIDMapping, error) {
...
func (c *criService) parseUsernsAllIDs(UIDMap, GIDMap []*runtime.IDMapping) (uids, gids []runtimespec.LinuxIDMapping, err error) {
...
func (c *criService) validateUserns(userns *runtime.UserNamespace) (retUids, retGids []runtimespec.LinuxIDMapping, retErr error) {
	if userns == nil {
